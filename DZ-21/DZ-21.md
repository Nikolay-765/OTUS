...
## Выполнение задания
Берем стенд подготовленный при выполнении [ДЗ-19](https://github.com/Nikolay-765/OTUS/blob/main/DZ-19/DZ-19.md) \
...
должны лежать в ./Provisioning относительно Vagrant, используется для установки различного софта на VM, в том числе Nginx \
на CentralServer, а также и загрузки ssh_connection.sh на CentralRouter (/usr/local/bin).
...
С помощью nmap пытаемся сканировать 22 порт на INetRouter, ничего не выходит. \
