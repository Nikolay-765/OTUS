...
/etc/frr/frr.conf для VM Router1, Router2, Router3 соответственно, должны лежать в ./FRR_conf относительно Vagrant, копируются в VM с помощью  \
ansible сценария router.yml.
